	...
	<form class="form-horizontal">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4">${ ProdVO.prodName }</div>
			</div>
			<hr />
			...
			<div class="row">
				...
				<div class="col-sm-4">${ ProdVO.prodDetail }</div>
			</div>
			<hr />
			...
			<div class="row">
				...
				<div class="col-sm-4">${ ProdVO.manuDate }</div>
			</div>
			<hr />
			...
			<div class="row">
				...
				<div class="col-sm-4">${ ProdVO.price }</div>
			</div>
			<hr />
			...
			<div class="row">
				...
				<div class="col-sm-4">${ProdVO.role }</div>
			</div>
			<hr />
